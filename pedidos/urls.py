...
urlpatterns = [
    ...
    path('pedidos/<int:pk>/marcar-listo/', views.pedido_marcar_listo, name='pedido_marcar_listo'),
    ...
    path('ordenes/exportar/pdf/',       views.orden_exportar_pdf,   name='orden_exportar_pdf'),
    path('ordenes/exportar/excel/',     views.orden_exportar_excel, name='orden_exportar_excel'),
